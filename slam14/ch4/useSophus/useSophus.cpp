...
int main( int argc, char **argv )
{
    ...
    // cout << "SO(3) from vector: " << SO3_v << end.transpose() l;
    ...
    Eigen::Matrix3d update_matrix=Sophus::SO3d::exp(update_so3).matrix();//将李群转换为旋转矩阵
    ...
    cout << "SE3 from R,t= " << endl << SE3_Rt.log().transpose()  << endl;
    cout << "SE3 from q,t= " << endl << SE3_qt.log().transpose()  << endl;
...
// ref : https://blog.csdn.net/qq_38210354/article/details/106919646
